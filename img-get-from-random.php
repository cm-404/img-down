<?php
/**
 * @ProjectName: 图片盲盒自动下载
 * @Description: 图片盲盒自动下载，可适用于其他随机图片下载，基于 https://iw233.cn/API/Random.php 色图盲盒，0.05%概率出露点瑟图(每4000张稳定井一张)
 * @Author: cm-404
 * @GitHub: https://github.com/cm-404/img-down.git
 * @CreateDate: 2022/10/17 10:24
 * @Version: 1.0
 */
...
function down_img_count($_count_max = 50)
{
  ...
  while ($_count < $_count_max) {
    ...
    down_img_by_url($_url_pic, $_name_pic, 'iw233-' . date('Ymd'));//保存图片至本地文件夹
    $_count++;
